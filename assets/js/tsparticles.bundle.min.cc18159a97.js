...
!(function (t, e) {
  ...
  (() => {
    ...
    function L(t, e, i, s) {
      return m.create((t.x * (i - s)) / (i + s) + (2 * e.x * s) / (i + s), t.y);
    }
    function A(t) {
            ...
            if (this.options.orbits) {
              if (
                (void 0 === t.absorberOrbit &&
                  ...
                  (t.absorberOrbit.length = D(t.getPosition(), this.position)),
    ...
    class ke {
      ...
      load(t) {
        t &&
          (void 0 !== t.acceleration && (this.acceleration = O(t.acceleration)),
          void 0 !== t.enable && (this.enable = t.enable),
    ...
    class $e {
      ...
      load(t) {
        t &&
          (void 0 !== t.color && (this.color = fe.create(this.color, t.color)),
    ...
    class di extends li {
      ...
      async interact(t) {
        ...
        (a ? (this._lastPosition = { ...a }) : delete this._lastPosition,
          n && e.particles.push(s.quantity, e.interactivity.mouse, s.particles),
          (this._delay -= o));
      }
      isEnabled(t) {
        const e = this.container,
        ...
        ((this.container = t),
          ...
          (this._getPluginParticleColors = (t) => {
            ...
            for (const s of this._colorPlugins)
              if (
                (!e && s.particleFillColor && (e = Wt(s.particleFillColor(t))),
                !i &&
      ...
      constructor(t, e) {
        ((this._applyDensity = (t, e, i) => {
          ...
          const s = t.number,
            ...
            r = Math.min(n, a) * o + e,
            c = Math.min(this.count, this.filter((t) => t.group === i).length);
          ...
          (this.needsSort = !1),
          (this.lastZIndex = 0),
          (this._interactionManager = new Ni(t, e)));
        ...
        const e = t.id ?? `tsparticles${Math.floor(1e4 * _())}`,
          ...
          n = o
            ? await (async function (t) {
                ...
                return i.ok
                  ? i.json()
                  : ($().error(`${f} ${i.status} while retrieving config file`),
                    t.fallback);
    ...
    class Ss {
      constructor(t) {
        ((this.container = t),
          ...
          (this.updaters = [new zs(t), new Ms(t), new Cs(t), new Ps(t)]));
      }
      init() {}
      isEnabled(t) {
    ...
    async function Ts(t, e = !0) {
      (await (async function (t, e = !0) {
        ...
        await (async function (t, e = !0) {
          await t.addParticleUpdater("opacity", (t) => new ks(t), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addParticleUpdater("outModes", (t) => new Ss(t), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addParticleUpdater("size", () => new Os(), e);
        })(t, !1),
        await t.refresh(e));
    }
    class Rs {
      ...
      constructor(t, e) {
        (super(e),
          ...
          (this.handleClickMode = (t) => {
            const i = this.container.actualOptions.interactivity.modes.attract;
            if (i && "attract" === t) {
              (e.attract || (e.attract = { particles: [] }),
    ...
    class qs extends li {
        ...
        (super(t),
          ...
          (this._hoverBubbleOpacity = (t, e, i) => {
            ...
            const n = t.options.opacity.value,
              a = Bs(t.opacity?.value ?? 1, o, S(n), e);
      ...
      isEnabled(t) {
        const e = this.container,
          ...
          c = ot("bubble", a);
        return (
          !!(c || (r.enable && s.position) || (n.enable && s.clickPosition)) &&
          (J("bubble", r.mode) || J("bubble", n.mode) || c)
        );
      }
      loadModeOptions(t, ...e) {
        t.bubble || (t.bubble = new Fs());
    ...
    class Hs {
      constructor() {
        ((this.distance = 80), (this.links = new Vs()), (this.radius = 60));
      }
      get lineLinked() {
        return this.links;
      }
    ...
    class js {
      constructor() {
        ((this.distance = 100), (this.links = new Gs()));
      }
      get lineLinked() {
        return this.links;
      }
        ...
        (super(e),
          (this._clickRepulse = () => {
            ...
            if (
              ...
              for (const t of i.particles) t.velocity.setTo(t.initialVelocity);
              i.particles = [];
            }
          }),
          (this._hoverRepulse = () => {
          ...
          (this.handleClickMode = (t) => {
            const i = this.container.actualOptions.interactivity.modes.repulse;
                  ...
                  for (let t = 0, e = 0; ; ) {
                    ...
                    if (((i = m(r, o)), (r += o + 1), i === v)) {
                      ...
                      for (let s = 0; s < c[i].length; s++) {
                        ...
                        (u.data.set(
                          [o, n, r, h],
                          ao[l] * a.width + ro[l] * e + (t % (4 * a.width)),
                        ),
                          (t += 4));
                      }
                      c.length === 1 << o && o < 12 && o++;
        ...
        try {
          ((t.gifData = await (async function (t, e, i) {
            ...
            const o = await s.arrayBuffer(),
              ...
              a = new co(new Uint8ClampedArray(o));
    ...
    async function vo(t) {
      if ("svg" !== t.type) return void (await po(t));
      t.loading = !0;
    ...
    function mo(t, e, i, s) {
      const o = (function (t, e, i) {
          ...
          if (!s) return "";
          const o = Zt(e, i);
          if (s.includes("fill")) return s.replace(uo, () => o);
          const n = s.indexOf(">");
      ...
      return new Promise((e) => {
        ...
        (r.addEventListener("load", () => {
          ...
          r.addEventListener("error", async () => {
            ...
            (await po(i), (n.loaded = !0), (n.element = i.element), e(n));
          }),
          (r.src = a));
      });
    }
      ...
      draw(t, e, i, s, o) {
        ...
        if (n) {
          if (((t.globalAlpha = s), n.gif && n.gifData)) {
            ...
            let r = e.gifFrame ?? 0;
            const c = { x: 0.5 * -n.gifData.width, y: 0.5 * -n.gifData.height },
    ...
    async function wo(t, e = !0) {
          ...
          (t.loadImage = async (e) => {
            ...
            if (
              ...
              try {
                ...
                t.images.push(i);
                const s = e.gif ? fo : e.replaceColor ? vo : po;
                await s(i);
              } catch {
      ...
      (await t.addPlugin(i, e),
        await t.addShape(["image", "images"], new yo(t), e));
    }
    class xo extends St {
      constructor() {
        (super(), (this.sync = !1));
    ...
    class ko {
      constructor() {
        ((this.count = 0), (this.delay = new xo()), (this.duration = new _o()));
      }
      load(t) {
        t &&
          (void 0 !== t.count && (this.count = t.count),
    ...
    class Po {
      ...
      isEnabled(t) {
        return (
          !j() &&
          !t.destroyed &&
          t.container.actualOptions.interactivity.events.onHover.parallax.enable
        );
      }
      move(t) {
        const e = t.container,
    ...
    function Ro(t, e, i, s) {
      switch (t.options.collisions.mode) {
          ...
          !(function (t, e, i, s) {
            ...
            void 0 === o && void 0 !== n
              ...
              : void 0 !== o && void 0 === n
                ...
                : void 0 !== o &&
                  void 0 !== n &&
                  (o >= n ? So(t, 0, e, n, i, s) : So(e, 0, t, o, i, s));
          })(t, e, i, s);
          break;
        case "bounce":
          To(t, e);
        ...
        case "destroy":
          !(function (t, e) {
            (t.unbreakable || e.unbreakable || To(t, e),
    ...
    class Do extends fs {
      ...
      async interact(t, e) {
        ...
        for (const a of n) {
          ...
          D(s, n) > o + r || Ro(t, a, e, i.retina.pixelRatio);
        }
      }
      isEnabled(t) {
    ...
    class Bo extends fs {
      ...
      async interact(t) {
        ...
        const o = t.options.links,
          ...
          r = o.warp,
          c = r ? new Eo(e.x, e.y, a, s) : new Ki(e.x, e.y, a),
        ...
        ((this.container = t),
          ...
          (this._drawLinkTriangle = (t, e, i) => {
            ...
            const n = this.container,
              ...
              r = e.destination,
              c = i.destination,
              l = o.opacity ?? (e.opacity + i.opacity) / 2;
            l <= 0 ||
              n.canvas.draw((e) => {
                const i = t.getPosition(),
                  ...
                  d = c.getPosition(),
                  u = t.retina.linksDistance ?? 0;
                if (D(i, h) > u || D(d, h) > u || D(d, i) > u) return;
                let p = Vt(o.color);
                if (!p) {
                  const e =
                    void 0 !== s.id
          ...
          (this._getLinkFrequency = (t, e) => qo([t, e], this._freqs.links)),
          (this._getTriangleFrequency = (t, e, i) =>
            qo([t, e, i], this._freqs.triangles)),
    ...
    async function Uo(t, e = !0) {
      (await (async function (t, e = !0) {
        await t.addInteractor("particlesLinks", (t) => new Bo(t), e);
      })(t, e),
        await (async function (t, e = !0) {
          const i = new Ho();
          await t.addPlugin(i, e);
    ...
    async function jo(t, e = !0) {
      (await (async function (t, e = !0) {
        await t.addShape("polygon", new $o(), e);
      })(t, e),
        await (async function (t, e = !0) {
          await t.addShape("triangle", new Go(), e);
        })(t, e));
    }
    class No {
      constructor() {
    ...
    class tn {
      ...
      init(t) {
        ...
        o && (t.strokeColor = ie(o, t.strokeAnimation, e.retina.reduceFactor));
      }
      isEnabled(t) {
    ...
    class sn {
      ...
      async init(t) {
        const e = t.actualOptions;
        if (en.find((t) => J(t, e.particles.shape.type))) {
          const t = en
      ...
      particleInit(t, e) {
        if (!e.shape || !en.includes(e.shape)) return;
        const i = e.shapeData;
        if (void 0 === i) return;
        const s = i.value;
    ...
    async function on(t, e = !0) {
      (ys(t),
        await (async function (t, e = !0) {
          await t.addMover("parallax", () => new Po(), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addInteractor("externalAttract", (e) => new Ds(t, e), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addInteractor("externalBounce", (t) => new Is(t), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addInteractor("externalBubble", (t) => new qs(t), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addInteractor("externalConnect", (t) => new $s(t), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addInteractor("externalGrab", (t) => new Xs(t), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addInteractor("externalPause", (t) => new Ys(t), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addInteractor("externalPush", (t) => new Zs(t), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addInteractor("externalRemove", (t) => new Ks(t), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addInteractor("externalRepulse", (e) => new so(t, e), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addInteractor("externalSlow", (t) => new no(t), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addInteractor("particlesAttract", (t) => new Co(t), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addInteractor("particlesCollisions", (t) => new Do(t), e);
        })(t, !1),
        await Uo(t, !1),
        await (async function () {
          (b("ease-in-quad", (t) => t ** 2),
            b("ease-out-quad", (t) => 1 - (1 - t) ** 2),
            b("ease-in-out-quad", (t) =>
              t < 0.5 ? 2 * t ** 2 : 1 - (-2 * t + 2) ** 2 / 2,
            ));
        })(),
        await wo(t, !1),
        await (async function (t, e = !0) {
          await t.addShape("line", new Mo(), e);
        })(t, !1),
        await jo(t, !1),
        await (async function (t, e = !0) {
          await t.addShape(["edge", "square"], new Zo(), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addShape("star", new Qo(), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addShape(en, new sn(), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addParticleUpdater("life", (t) => new zo(t), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addParticleUpdater("rotate", (t) => new Yo(t), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addParticleUpdater("strokeColor", (t) => new tn(t), e);
        })(t, !1),
        await Ts(t, e));
    }
    class nn {
    ...
    class ln {
      constructor() {
        ((this.lines = new cn()), (this.particles = new cn()));
      }
      load(t) {
    ...
    class un {
      constructor() {
        ((this.distance = 5), (this.enable = !1), (this.speed = new dn()));
      }
      load(t) {
        if (
          t &&
    ...
    async function fn(t, e = !0) {
      (await (async function (t, e = !0) {
        ...
        await (async function (t, e = !0) {
          await t.addParticleUpdater("tilt", (t) => new rn(t), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addParticleUpdater("twinkle", () => new hn(), e);
        })(t, !1),
        await (async function (t, e = !0) {
          await t.addParticleUpdater("wobble", (t) => new pn(t), e);
        })(t, !1),
        await (async function (t, e = !0) {
